  ...
  Widget build(BuildContext context) {
    return Consumer<BrandController>(
      builder: (context, brandProvider, child) {
        ...
        SingleChildScrollView(scrollDirection: Axis.horizontal, child: Row(children: brandProvider.brandList.map((brand)=> InkWell(splashColor: Colors.transparent, highlightColor: Colors.transparent,
          onTap: () {
          ...
          Dimensions.paddingSizeDefault : 0,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
              Container(width: ResponsiveHelper.isTab(context)? 120 :80, height: ResponsiveHelper.isTab(context)? 120 :80,
                ...
                child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(300)),
