...
class _CategoryScreenState extends State<CategoryScreen> {
  @override
  void initState() {
    Provider.of<ProductController>(context, listen: false).initBrandOrCategoryProductList(false, Provider.of<CategoryController>(context, listen: false).categoryList[0].id.toString(), context);
    super.initState();
  }
  @override
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if(index != 0) {
                        ...
                        print('dead:'+'${subCategory.imageFullUrl?.path}');
                      }
                      if(index == 0) {
                              ...
                              key: Key('${Provider.of<CategoryController>(context).categorySelectedIndex}$index'),
                                ...
                                children: [
                                  Container(
                                    ...
                                    width: 64,
                                    child: Image.network(
                                      '${subCategory.imageFullUrl?.path}', // Use a default image if null
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                 // print('${subCategory.imageFullUrl?.path}'), // Corrected `print` statement
                                  Text(
                                    subCategory.name!,
                          ...
                          child: ListTile(
                            title: Column(
                              children: [
                                ...
                                Text(subCategory.name!, style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 2, overflow: TextOverflow.ellipsis),
                              ],
                            ),
