                    ...
                    builder: (context, constraints) {
                      ...
                      return Row(
                        children: [
                          SizedBox(
                              width: width *
                                  0.3), // Adjust this for proper spacing
                          Expanded(
                            child: Align(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/FeaturedProduct.png',
                                      ),
                                    ],
                                  ),
                                ],
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Image.asset(
                                        'assets/images/FeaturedDeal.png',
                                      ),
                                    ],
                                  ),
                                ],
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => AllProductScreen(
                                      productType: ProductType.sellerProduct,
                                    )),
                              );
                            },
                            child: Container(
