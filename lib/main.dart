...
if(Firebase.apps.isEmpty){
  if(Platform.isAndroid){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyAIUvG9OSfbPT6nibVYU-edxtlrITxEVM4",
        projectId: "bharatoutletstore-15624",
        messagingSenderId: "1:508923988043:android:df9561fda750b7b48e65ce",
        appId: "bharat-outlet-source",
      storageBucket: "bharatoutletstore-15624.appspot.co",
    ));
  }else{
